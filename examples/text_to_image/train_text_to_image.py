                ...
                if global_step % args.checkpointing_steps == 0 and global_step:
                    ...
                    if accelerator.is_main_process or deepspeed_plugin is not None:
                        ...
                        if args.checkpoints_total_limit is not None:
                            checkpoints = os.listdir(os.path.join(args.output_dir, "unets" if args.save_unet_only else "checkpoints"))
                            ...
                            if len(checkpoints) >= args.checkpoints_total_limit:
                                ...
                                for removing_checkpoint in removing_checkpoints:
                                    removing_checkpoint = os.path.join(args.output_dir, "unets" if args.save_unet_only else "checkpoints", removing_checkpoint)
